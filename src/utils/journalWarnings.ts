...
export const WARNING_PATTERNS: readonly WarningPattern[] = [
  // quic-go, дословно из его исходников. Именно это печатает sing-box для hysteria2 и tuic, когда
  // ядро срезало буфер: строка содержит и желаемый, и полученный размер — это и есть диагноз.
