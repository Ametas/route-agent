...
// uploadOlcrtcBinaryHandler removed — replaced by uploadOlcrtcAgentSrvBinaryHandler in
// src/services/olcrtc.service.ts (single binary, no ALLOWED_BINARIES branching needed — that
// existed only to distinguish olcrtc/olcrtc-manager, both gone from the architecture now).
